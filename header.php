...
<html lang="es">
	...
	<body>
		<header>
			<a id="name_usuario">Bienvenido <?php echo $_SESSION['name_user'];?></a>
			<h1><em>STUAN</em></h1>
			...
			<nav>
				...
				<ul class="mi-menu">
					...
					<li class="li1"><a href="modifica_album.php" class="enlace_menu">Administrar</a></li>
					</li>
				</ul>
				<a class="icon-user" id="loggin_nav" href="php/salir.php" >Salir</a>
			</nav>
